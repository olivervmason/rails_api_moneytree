...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { title: @column.title, user_id: @column.user_id } }, as: :json
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { title: @column.title, user_id: @column.user_id } }, as: :json
    assert_response 200
  end
